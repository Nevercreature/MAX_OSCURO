...
public class FilaBloquesDelanteros01 : MonoBehaviour {


    public GameObject BloqueDelantero;
    public GameObject TuboIntermedio;
    ...
    void Awake()
    {
      ...
      //  Instantiate(BloqueDelantero, new Vector3(transform.position.x, -224, BloqueDelantero.transform.position.z), Quaternion.identity);
        ...
        Instantiate(BloqueDelantero, new Vector3(transform.position.x, -96, BloqueDelantero.transform.position.z), Quaternion.identity);
        Instantiate(BloqueDelantero, new Vector3(transform.position.x, -64, BloqueDelantero.transform.position.z), Quaternion.identity);
        Instantiate(BloqueDelantero, new Vector3(transform.position.x, -32, BloqueDelantero.transform.position.z), Quaternion.identity);

        Instantiate(TuboIntermedio, new Vector3(transform.position.x, 0, TuboIntermedio.transform.position.z), Quaternion.identity);
